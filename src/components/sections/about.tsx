          ...
          <AnimationWrapper animation="fade-right">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed text-lg mt-4">
                Outside of coding, I enjoy watching movies, playing football,
                and music. I believe that balancing work, hobbies, and fun helps
                me stay motivated and keep growing every day.
              </p>
